...
namespace SugarM.Controllers
{
    public class DocCtrRunnoController : BaseController<DocCtrRunno>
    {
        ...
        public IActionResult Index()
        {
            ...
            var Call = ServiceExtension.RestshapExtension.CallRestApiGET(AuthorList, "http://192.168.10.46/sdapi/sdapi/DocCtrlRunnoNGet?Compcode=" + _CompCode.CompCode + "&CaneYear=" + year, Getkey());
            return View(Call);
        }
        ...
        [HttpPost]
        public IActionResult Create(DocCtrRunno _DocRunning, string IsEditMode)
        {
