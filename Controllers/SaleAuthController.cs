...
namespace SugarM.Controllers {
    public class SaleAuthController : BaseController<SaleAuth> {
        ...
        public IActionResult Index () {
            ...
            var Call = CallRestApiGET (AuthorList, "http://192.168.10.46/sdapi/sdapi/SaleAuthget");
        ...
        public IActionResult Create (string _Id) {
            ...
            var Call2 = CallRestApiGET (Companyget1, "http://192.168.10.46/sdapi/sdapi/regionGet");
            ...
            if (_Id == null) {
                ...
                var saleviewmodel = CallRestApiGET (saleview, "http://192.168.10.46/sdapi/sdapi/saleAuthget/" + _Id);
        ...
        public IActionResult Create (SaleAuth _SaleAuth, string IsEditMode) {
            ...
            if (IsEditMode.Equals ("false")) {
                var _Re = CallRestApiPOST (_SaleAuth, "http://192.168.10.46/sdapi/sdapi/saleAuthPost");
                if (_Re.success) {
                ...
                var _Re = CallRestApiPOST (_SaleAuthUp, "http://192.168.10.46/sdapi/sdapi/saleAuthPut/" + _SaleAuth.CompCodeEdit + "/" + _SaleAuth.SaleIdEdit + "/" + _SaleAuth.RegionCodeEdit);
                if (_Re.success) {
                    _clientNotification.AddSweetNotification ("สำเร็จ",
        ...
        public IActionResult EditMutiple (string Id, string RegId, string SaleId) {
            ...
            var saleviewmodel = CallRestApiGET (saleview, "http://192.168.10.46/sdapi/sdapi/SaleAuthGet/" + SaleId);
            _Salestamodel.Salelist = saleviewmodel;
            ...
            var _Resale = CallRestApiGET (Drsale, "http://192.168.10.46/sdapi/sdapi/saleGet");
            var salefull = new List<SaleAuth> ();
            ...
            var _Reregion = CallRestApiGET (Drbranch, "http://192.168.10.46/sdapi/sdapi/regionGet");
            var branch = new List<SaleAuth> ();
        ...
        public IActionResult Delete (string Id, string Del, string Del1) {
            ...
            var Call = CallRestApiPOST (_SaleAuth, "http://192.168.10.46/sdapi/sdapi/SaleAuthDel/" + Id + "/" + Del + "/" + Del1);
