...
namespace SugarM.Controllers
{
    ...
    public class CompanyController : BaseController<Company>
    {
        ...
        [HttpGet]
        [DisplayName("ค้นหาบริษัทในเครือ")]
        ...
        [HttpGet]
        [DisplayName("ค้นหาบริษัท/[CompId]")]
        ...
        [HttpGet]
        [DisplayName("ค้นหาสาขาRegion/[CompId]/[Year]")]
        ...
        [DisplayName("ค้นหาสาขา/[branchid]/[Compid]")]
        [HttpGet]
