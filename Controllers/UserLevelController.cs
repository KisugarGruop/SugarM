...
namespace SugarM.Controllers
{
    public class UserLevelController : BaseController<UserLevel>
    {
        ...
        public async Task<IActionResult> Create()
        {
            ...
            var Call = ServiceExtension.RestshapExtension.CallRestApiGET(AuthorList, "http://192.168.10.46/sdapi/sdapi/UserGet/" + _UserProfile.CompCode, Getkey());
        ...
        public IActionResult Edit(string CompCode, string CaneYear, string UserId)
        {
            ...
            var CallDrow = ServiceExtension.RestshapExtension.CallRestApiGET(_DrowAuthorList, "http://192.168.10.46/sdapi/sdapi/UserLike/" + UserId, Getkey());
